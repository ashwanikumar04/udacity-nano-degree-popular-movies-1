...
public class DetailsActivity extends BaseActivity {
    ...
    private void showData(int type) {
        try {
            ...
            dialogCancel.setImageDrawable(FontIconHelper.getFontDrawable(this, MaterialIcons.md_cancel));
            ...
            recyclerView.setAdapter(type == Constants.DetailType.REVIEWS
                    ? new ReviewsAdapter(this, reviewsAndTrailersResponse.getReviews().getResults())
                    : new TrailersAdapter(this, reviewsAndTrailersResponse.getTrailers().getYoutube(), handler));
    ...
    private void initializeFloatingActionButtons() {
        ...
        reviews
                .setImageDrawable(new IconDrawable(this, MaterialIcons.md_view_headline)
        ...
        trailers
                .setImageDrawable(new IconDrawable(this, MaterialIcons.md_play_circle_filled)
                        .colorRes(R.color.white)
                        .actionBarSize());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setToolBar(true);
        serviceGenerator = new RetroClientServiceGenerator(this,
                false);
